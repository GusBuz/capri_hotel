        ...
        <div class="pageContent">
            <form action="${index}" method="post" id="deleteForm">
                <div class="backgroundContainer">
                    ...
                    <h2>"${requestScope.exceptionMsg}"</h2>
                    <img src="${path}/images/wrong.svg" class="halfIllustration" alt="Ilustração de pessoas montando quebra-cabeças.">
                    <input type="button" value="Voltar" class="buttons" onclick="window.location.href='${home}'">
                </div>
            </form>
        </div>
    </body>
